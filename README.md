...
Rode ```npm start``` ou ```yarn start``` nas pastas backend e mobile, acesse **localhost:19002**, leia o QR Code no seu celular e utilize o aplicativo <img src="imgs/expo.png" alt="rocketseat" height="20"> Expo para rodar a versão mobile no seu smartphone. Ou com algum emulador Android/iOS para rodar no seu computador.
...
## Licença
[MIT](https://github.com/davioliveira-dev/be-the-hero/blob/master/LICENSE)

---

<h4 align="center"> Feito por <a href='http://davioliveira-dev.devport.co'><strong>Davi Oliveira</strong></h4>
